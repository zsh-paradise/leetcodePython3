...
def testBasicFunc():
    # 加载测试数据集
    datMat = mat(loadDataSet(setting.test_address+'/10.KMeans/testSet.txt'))
...
def testBiKMeans():
    # 加载测试数据集
    datMat = mat(loadDataSet(setting.test_address+'/10.KMeans/testSet2.txt'))
